ARG ALMA_REPOS_IMAGE=quay.io/almalinuxorg/10-kitten-base:10-kitten
...
COPY build_files/almalinux-10-kitten-minimal-plus.yaml \
    /usr/share/doc/bootc-base-imagectl/manifests/almalinux-10-kitten-minimal-plus.yaml

RUN /usr/libexec/bootc-base-imagectl build-rootfs \
    --reinject \
    --manifest=almalinux-10-kitten-minimal-plus \
    /target-rootfs
...
LABEL containers.bootc=1 \
      ostree.bootable=1 \
      org.opencontainers.image.title="Home Server Base 10 Next" \
      org.opencontainers.image.description="Generic AlmaLinux Kitten 10 minimal-plus-derived bootc base for Home Server Project systems" \
      ...
      io.home-server-project.base.profile="almalinux-kitten-10-minimal-plus" \
      io.home-server-project.base.channel="next"
